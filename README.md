...
This is a test - View on [shylanott.com](https://www.shylanott.com) 
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/4jxpnyef/settings/api) and create a token with read rights.
